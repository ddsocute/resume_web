        ...
        <section id="hero" className="relative bg-white min-h-[60vh] flex items-center pt-20 pb-16 lg:pt-32 lg:pb-20">
            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="inline-block border-l-2 border-slate-900 pl-4">
                                <p className="font-mono text-sm lg:text-base text-slate-500 uppercase tracking-[0.2em]">
                                    Bridging Finance with AI Intelligence
                                </p>
                            </div>
                        </div>

                        <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                            專注於企業併購、財務估值與 MLLM 應用研究。致力於利用技術創新優化金融決策路徑。
                        </p>

                        <div className="flex flex-wrap gap-4 pt-4">
                            <a
                                href={`mailto:${profile.email}`}
                                className="flex items-center gap-2 px-8 py-3 bg-slate-900 text-white hover:bg-slate-800 transition-all text-xs font-mono tracking-widest uppercase"
                            >
                            ...
                            <a
                                ...
                                className="flex items-center gap-2 px-8 py-3 border border-slate-200 text-slate-900 hover:bg-slate-50 transition-all text-xs font-mono tracking-widest uppercase"
                            >
                    ...
                    {/* Right Photo Block - Fixed White Background */}
                    <motion.div
